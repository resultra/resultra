...
func filterOneRecord(recordRef RecordRef, filterRules []FilterRuleRef) (bool, error) {
...
func GetFilteredRecords(appEngContext appengine.Context) ([]RecordRef, error) {
	...
	unfilteredRecordRefs, getRecordErr := GetRecords(appEngContext)
	if getRecordErr != nil {
